...
export function addToDB() {
	...
	// var objectStoreRequest = objectStore.add({ 'uid': this.closest('.content_container').getAttribute('data-uid'), 'content': this.closest('.content_container').children[1].textContent });
