      ...
      _createClass(_default, [
        ...
        },
        {
          ...
          value: function addElements() {
            ...
            els.forEach(function(el, i) {
              ...
              var top =
                el.getBoundingClientRect().top + _this4.instance.scroll.y;

              var bottom = top + el.offsetHeight;
              var offset =
                typeof el.dataset[_this4.name + 'Offset'] === 'string'
                  ? el.dataset[_this4.name + 'Offset'].split(',')
                  : false;
                ...
                for (var i = 0; i < offset.length; i++) {
                  if (offset[i].includes('%')) {
                    relativeOffset[i] = parseInt(
                      (offset[i].replace('%', '') * _this4.windowHeight) / 100
                    );
                  } else {
        ...
        },
        {
          ...
          value: function updateElements() {
            ...
            this.els.forEach(function(el, i) {
              var top =
                el.el.getBoundingClientRect().top + _this5.instance.scroll.y;
        ...
        },
        {
          ...
          value: function addSections() {
            ...
            sections.forEach(function(section, i) {
              ...
              if (
                _this7.instance.scroll.y >= offset &&
                _this7.instance.scroll.y <= limit
              ) {
                inView = true;
              }
        ...
        },
        {
          ...
          value: function scrollTo(targetOption, offsetOption) {
            ...
            this.inertiaRatio = Math.min(
              4000 / Math.abs(this.instance.delta.y - this.instance.scroll.y),
              0.8
